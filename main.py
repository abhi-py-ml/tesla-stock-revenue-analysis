...
if html_data.status_code==200:
    ...
    def make_graph(stock_data, revenue_data, stock):
        ...
        axes[0].plot(stock_data_specific.Date, stock_data_specific.Close, label="Share Price")
        axes[0].set_ylabel("Price ($US)")
        axes[0].set_title(f"{stock} - Historical Share Price")
        axes[0].legend()

        axes[1].plot(revenue_data_specific.Date, revenue_data_specific.Revenue, label="Revenue")
